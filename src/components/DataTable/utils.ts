type ArrayOfLength<
  ...
  SizedArray extends Array<unknown> = [],
> = SizedArray['length'] extends Length
  ? SizedArray
  : ArrayOfLength<Length, [...SizedArray, SizedArray['length']]>

type MaxLength = ArrayOfLength<10>[number]

type ArrayIndex<A extends ReadonlyArray<any>, Keys extends number = never> =
  A extends readonly []
    ? Keys
    ...
    : T extends Date
      ...
      : T extends object
        ? Extract<keyof T, string | number> |
            PrefixPath<T, Extract<keyof T, string | number>>
        : never
